...
return [
    ...
    'lte' => [
        ...
        'file' => 'Размер поля :attribute должен быть не больше :value килобайт.',
    ...
    'password' => [
        ...
        'uncompromised' => 'Указанное значение поля :attribute встречается в утечках данных. Пожалуйста, выберите другое значение.',
    ],
